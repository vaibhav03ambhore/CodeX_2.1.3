  ...
  return (
    <section className='pt-[95px] md:flex rtl bg-nc'>
      ...
      <div className='right md:w-[80%] p-3 border-s-4 border-indigo-500/75'>
        <div className="md:flex bg-white border border-gray-200 rounded-lg shadow mb-2 font-cus">
          <img className="rounded-t-lg md:max-w-[30%] max-h-[20%]" src={Img1} />
          <div className="p-2">
            ...
            <p className="mb-3 font-cus text-gray-700">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
            <Link to={'/bidding'}>
        ...
        <div className="md:flex bg-white border border-gray-200 rounded-lg shadow mb-2">
          <img className="rounded-t-lg md:max-w-[30%] max-h-[20%]" src={Img1} />
          <div className="p-2">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">Noteworthy technology acquisitions 2021</h5>
            <span class="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
