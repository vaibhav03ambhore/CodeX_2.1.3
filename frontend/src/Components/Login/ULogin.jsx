                ...
                <div className="py-4 px-4 mx-auto max-w-screen-xl lg:py-16">
                    <div>
                        <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl">
                            ...
                            <form className="mt-8 space-y-6 font-cus" action="#">
                                <div>
                                ...
                                <button type="submit" className="w-full px-5 py-3 text-base font-cus text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 sm:w-auto">Login to your account</button>
                                <div className="text-sm  text-gray-900">
                                    Not registered yet? <Link to={'/uregister'}><a className="text-blue-600 hover:underline ">Create account</a></Link>
                                </div>
                            </form>
                        </div>
                    </div>
