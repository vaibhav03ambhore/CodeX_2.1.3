                    ...
                    <div>
                        <div className="w-full bg-danger lg:max-w-xl p-6 space-y-4 sm:p-4 bg-white rounded-lg shadow-xl">
                            ...
                            <form className="mt-8 space-y-6" action="#">
                                <div>
                                    <label for="name" className="block mb-2 text-sm font-medium text-gray-900">Bidder Name</label>
                                ...
                                <div>
                                    <label for="mobile" className="block mb-2 text-sm font-medium text-gray-900">Mobile Number</label>
                                    <input type="mobile" name="mobile" id="mobile" placeholder="Mobile" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                                </div>
                                <div>
